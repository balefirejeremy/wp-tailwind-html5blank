...
{
    // normalize-css
    wp_register_style('normalize', get_template_directory_uri() . '/css/app.css', array());
    // Custom CSS
    wp_register_style('html5blank', get_template_directory_uri() . '/style.css', array('normalize'));
    // Register CSS
    wp_enqueue_style('html5blank');
    // Custom CSS
    wp_register_style('html5blankcssmin', get_template_directory_uri() . '/style.css', array());
    // Register CSS
...
{
    global $post;
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . esc_html('View Article') . '</a>';
}
    ...
    <<?php echo esc_html($tag) ?> <?php comment_class(empty($args['has_children']) ? '' : 'parent') ?> id="comment-<?php comment_ID(); ?>">
        <?php if ('div' != $args['style']) : ?>
            ...
            <div class="comment-author vcard">
                ...
                <cite class="fn"><?php echo get_comment_author_link(); ?></cite> <span class="says"><?php esc_html_e('says:'); ?></span>
            </div>
            ...
            <div class="comment-meta commentmetadata"><a href="<?php echo htmlspecialchars(get_comment_link($comment->comment_ID)); ?>">
                    <?php printf(esc_html('%1$s at %2$s'), get_comment_date(), get_comment_time()); ?></a><?php edit_comment_link(esc_html_e('(Edit)'), '  ', ''); ?>
            </div>
